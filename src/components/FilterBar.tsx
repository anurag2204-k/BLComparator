...
export function FilterBar({ columnTitle, resultCount }: FilterBarProps) {
  return (
    <div className="sticky top-[60px] z-40 bg-card/95 backdrop-blur border-b border-border px-4 py-2.5 mb-3 rounded-md shadow-sm flex items-center justify-between">
